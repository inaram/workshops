def fitnessChallenge():
    challengeLength = int(raw_input("How many days do you want your fitness challenge to last? "))
    totalMinutes = 0
    totalDays = 0 

    for day in range(1, challengeLength + 1):
        answer = raw_input("Have you exercised today? (y/n): ")
        if answer == "y" or answer == "yes" or answer == "Y" or answer == "Yes" or answer == "YES":
            totalDays += 1
            print "Great job!"
            addMinutes = int(raw_input("For how many minutes? "))
